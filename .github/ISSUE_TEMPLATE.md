...
- [ ] Typo
- [ ] Bug
- [ ] Additional sample request / idea
...
>
> If you are planning to share a new feature request (enhancement / suggestion), please use the [Office Development, Microsoft Graph / Office 365 REST API UserVoice](https://officespdev.uservoice.com/forums/224641-feature-requests-and-feedback/category/101632-microsoft-graph-o365-rest-apis). (DELETE THIS PARAGRAPH AFTER READING)
>
> _(DELETE THIS PARAGRAPH AFTER READING)_
>
...
> - If you have technical questions about the Microsoft Graph, we’ll be monitoring #microsoft-graph on (Stack Overflow)[https://stackoverflow.com/questions/tagged/microsoft-graph].
