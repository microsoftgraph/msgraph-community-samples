...
> NOTE: See **[microsoftgraph/uwp-csharp-meetingbot-sample](https://github.com/microsoftgraph/uwp-csharp-meetingbot-sample)** for the sample. This entry simply cross-references that sample.
